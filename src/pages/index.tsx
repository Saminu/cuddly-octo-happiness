...
const Home: NextPage = () => {
  ...
  const proTitle = (
    <>
      Syntheca<span className="ml-1 text-amber-500/90">Pro</span>
    </>
  );
          ...
          >
            ...
            >
              <div className="flex flex-row items-start ">
                <span className="text-4xl font-bold text-[#364958] xs:text-5xl sm:text-6xl">
                  Syntheca
                </span>
                <span className="text-4xl font-bold text-[#364958] xs:text-5xl sm:text-6xl">
                  {/* GPT */}
            ...
            <Expand className="flex w-full flex-row">
              <ChatWindow
                className="sm:mt-4"
                messages={messages}
                title={session?.user.subscriptionId ? proTitle : "Syntheca"}
                onSave={
                  shouldShowSave
                    ? (format) => {
                        setHasSaved(true);
